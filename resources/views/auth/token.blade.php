                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('auth.token') }}">
                            ...
                            <div class="form-group row">
                                <label for="token" class="col-sm-4 col-form-label text-md-right">{{ __('Token') }}</label>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    ...
                                    @if (request()->session()->get('authy.using_sms'))
                                        <hr>
                                        <p class="help-block">Token not arrived? <a href="{{ route('auth.token.resend') }}">Resend token</a></p>
                                    @endif
                                </div>
                            </div>
                        </form>
